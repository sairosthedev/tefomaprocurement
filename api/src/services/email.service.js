...
const sendEmailNotification = async ({
  ...
  try {
    ...
    console.log('Email sent successfully:', email?.id || email?.data?.id || 'Email queued');
    return email;
  } catch (error) {
 ...
 */
const getSimpleEmailTemplate = (heading, message, subMessage, buttonText, buttonLink) => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
 ...
 */
const sendNotificationEmail = async (notification, userEmail = null) => {
  try {
 ...
 */
const getEmailContentForNotification = (notification) => {
